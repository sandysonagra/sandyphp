...
<body>
    <div class="container">
        <center>
            <h2>REGISTER FORM</h2>
            <h3><a href="joinform.php">ADD MOBILE BRAND</a></h3>
        </center>
        <form action="validation.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <?php
                    $sql = "SELECT 'session_crud_by_sandip_sixth_time.mobile','join_session.price' FROM `session_crud_by_sandip_sixth_time` INNER JOIN `join_session` ON 'session_crud_by_sandip_sixth_time.mobile' = 'join_session.mobile' ";
                    $result = mysqli_query($conn,$sql);
