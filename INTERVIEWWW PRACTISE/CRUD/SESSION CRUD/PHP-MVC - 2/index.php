...
if (isset($_GET['editid'])) {
    ...
    $sql = "SELECT * FROM `session_crud_by_sandip_second_time` WHERE `id`='$id'";
    ...
    <div class="container">
        ...
        <form action="validation.php" method="post" enctype="multipart/form-data">
            ...
            if(isset($_GET['editid']) || $_GET['updateid'])
            {
                ...
                echo'<input type="submit" name="update" class="form-control btn btn-info" value="UPDATE">';
            }
            else{

                echo'<input type="submit" name="submit" class="form-control btn btn-primary" value="SUBMIT">';
            }
...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM `session_crud_by_sandip_second_time`";
            $result = mysqli_query($conn, $sql);
